<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdvanceBooking.aspx.cs" Inherits="Parshvnath.AdvanceBooking" %>
...
<head id="Head1" runat="server">
    <title>View Advance Booking </title>
    ...
    <script>
        ...
        function InitializeAutocomplete() {
            ...
            $(function () {
                ...
                $(".advance-booking td:first-child").css({ "text-align": "right", "width": "150px", "font-size": "50px", "font-weight": "normal" })
                    ...
                    <div class="Nav_Center">
                        <ul class="main_nav">
                            <li><a href="HoardingMasterDetail.aspx">Home</a></li>
                             <li><a href="AdvanceBooking.aspx" class="active">Advance Booking</a></li>
