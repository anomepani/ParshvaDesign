<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewHoardingReport.aspx.cs" Inherits="Parshvnath.ViewHoardingReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>View Hoarding Report</title>
    ...
    <script>
        ...
        function EditUser(UserID) {
            $.ajax({
                type: "POST",
                // url: "/parshva/ViewUser.aspx/EditUser",
                url: "ViewUser.aspx/EditUser",
                data: "{'UserID': '" + UserID + "'}",
                ...
                success: function (result) {
                    ...
                    if (user == "-1") {
                        ...
                        $("#txtPersonName").val(user.PersonName);
        ...
        function DeleteUser(UserID) {
            $.ajax({
                type: "POST",
                //url: "/parshva/ViewUser.aspx/DeleteUser",

                url: "ViewUser.aspx/DeleteUser",
                data: "{'UserID': '" + UserID + "'}",
                contentType: "application/json",
                dataType: "json",
                success: function (result) {
        ...
        function AddUser(Name, Phone, Address, Email, Operation, ID, PersonName, City) {
            $.ajax({
                type: "POST",
                //url: "/parshva/ViewUser.aspx/AddUser",
                url: "ViewUser.aspx/AddUser",
