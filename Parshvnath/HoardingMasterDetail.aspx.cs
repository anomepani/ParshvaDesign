...
{
    public partial class HoardingMasterDetail : System.Web.UI.Page
    {
        ...
        protected void BindHoardingMasterGrid()
        {
            ...
            try
            {
                gvHoardingMaster.DataSource = Global.dc.GetHoardingDetails().ToList();
        ...
        protected void gvHoardingMaster_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                var data = e.Row.DataItem as GetHoardingDetails_Result;
                ...
                // Commented on 02-APR-2017
                //// OLD CODE FOR ACTIVE AND INACTIVE ROW 
